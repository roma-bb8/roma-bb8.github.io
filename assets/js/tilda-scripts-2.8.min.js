...
if(window.mainMetrika>''&&window[window.mainMetrika]){if(isVirtPage){window[window.mainMetrika].hit(virtPage,{title:virtTitle,referer:referer,order_price:price})}else{window[window.mainMetrika].reachGoal(virtPage,{title:virtTitle,referer:referer,order_price:price})}}
if(window.dataLayer!=undefined){if(isVirtPage){if(price>0){window.dataLayer.push({'event':'pageView','eventAction':virtPage,'title':virtTitle,'value':price,'referer':referer})}else{window.dataLayer.push({'event':'pageView','eventAction':virtPage,'title':virtTitle,'referer':referer})}}else{window.dataLayer.push({'event':virtPage,'eventAction':virtTitle,'value':price,'referer':referer})}}
if(window.fbq!=undefined){if(isVirtPage){var currency=$('#allrecords').data('tilda-currency');if(price>0&&currency){window.fbq('track','InitiateCheckout',{content_name:virtTitle,content_category:virtPage,value:price,currency:currency,referrer:referer})}else{window.fbq('track','Lead',{content_name:virtTitle,content_category:virtPage,referrer:referer})}}else{window.fbq('track',virtPage,{content_name:virtTitle,value:price,referrer:referer})}}
